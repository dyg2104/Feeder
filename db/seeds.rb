...
Category.create({ title: "Startups" })
...
Feed.create_feed("The Economist: Finance and Economics", "http://www.economist.com/feeds/print-sections/79/finance-and-economics.xml", 14)
